...
if len(sys.argv) < 2:
	print("s2url - v1.0")
	print()
	print("By Gomiero (c) 2025-2025")
	print("this SOFTWARE is licensed only to THE OWNER, for private use.")
	print()
	print("Converte uma string para URLENCODE")
	print()
	print("s2url [string]")
	print()
	sys.exit(1)
...
s = sys.argv[1]
r = urllib.parse.urlencode({"a": s})[2:]
print(r)
